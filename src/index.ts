...
export const getUserLocales = memoize(getUserLocalesInternal, { cacheKey: JSON.stringify });
...
export const getUserLocale = memoize(getUserLocaleInternal, { cacheKey: JSON.stringify });
